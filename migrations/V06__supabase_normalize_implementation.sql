-- Supabase Normalization Implementation
-- This migration was created to solve JSONB index size limits encountered during testing
-- Normalizes puzzle article storage to support unlimited categories and aliases
