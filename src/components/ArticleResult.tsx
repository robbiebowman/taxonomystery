...
const SUCCESS_VARIATIONS = [
  ...
  { headline: "HISTORY MADE", location: "Rome", text: "Historians will mark this day as the moment the world finally understood <title>." },
  { headline: "CONFIRMED SIGHTING", location: "Loch Ness", text: "It's no monster, but it is definitely <title>. The photos are conclusive." },
  { headline: "BULLSEYE!", location: "Dartford", text: "A direct hit! The answer <title> lands right in the center of the board." },
  { headline: "MYSTERY DECODED", location: "The Pentagon", text: "Top cryptographers have decrypted the signal. It reads: <title>." },
  { headline: "THE EAGLE HAS LANDED", location: "Houston", text: "Control, we have a solution. The subject is <title>." },
  { headline: "UNANIMOUS VOTE", location: "The Senate", text: "The motion to recognize <title> has passed with zero objections." },
  { headline: "EXCLUSIVE SCOOP", location: "Fleet Street", text: "Our reporters have the story of the century: it's <title>." },
  { headline: "NOBEL PRIZE WORTHY", location: "Stockholm", text: "The committee is considering a new category for the discovery of <title>." },
  { headline: "PERFECT MATCH", location: "Tinder HQ", text: "It's a swipe right! <title> is exactly what we were looking for." },
  { headline: "CHECKMATE", location: "Reykjavik", text: "In a brilliant endgame maneuver, the answer <title> secures the win." },
  { headline: "TOUCHDOWN!", location: "Super Bowl", text: "The crowd goes wild as <title> makes it to the end zone!" },
  { headline: "STANDING OVATION", location: "Broadway", text: "The curtain falls, and the audience cheers for <title>." },
  { headline: "GOLD MEDAL", location: "The Podium", text: "The national anthem plays for <title>. A world-record performance." },
  { headline: "FIVE STARS", location: "Michelin Guide", text: "A culinary masterpiece. <title> is exquisite in every way." },
  { headline: "JACKPOT!", location: "Monte Carlo", text: "The slots align: 7-7-7. The payout is <title>." },
  { headline: "X MARKS THE SPOT", location: "Treasure Island", text: "We dug deep and found the buried chest containing <title>." },
  { headline: "ELEMENTARY!", location: "Baker Street", text: "\"It was simple deduction, Watson. The answer had to be <title>.\"" },
  { headline: "MISSION SUCCESS", location: "Cape Canaveral", text: "The payload <title> has reached orbit successfully." },
  { headline: "CLEAN SWEEP", location: "Oscars", text: "And the award for Best Answer goes to... <title>!" },
  { headline: "LIBRARY RECORD", location: "Alexandria", text: "The missing scroll has been returned. It is titled <title>." },
]
...
const FAILURE_VARIATIONS = [
  ...
  { headline: "DEAD END", location: "The Maze", text: "We turned left at <guess> and hit a brick wall. Retracing our steps now." },
  { headline: "SYSTEM CRASH", location: "The Matrix", text: "Trying to load <guess> caused a fatal exception. Rebooting reality." },
  { headline: "LOST IN TRANSLATION", location: "Tower of Babel", text: "We thought it meant <guess>, but apparently it means something else entirely." },
  { headline: "RED HERRING", location: "The Fish Market", text: "It smells like <guess>, but it's just a distraction. Keep looking." },
  { headline: "MATH ERROR", location: "Calculus Class", text: "We forgot to carry the one. <guess> is mathematically impossible." },
  { headline: "OUT OF TUNE", location: "The Opera", text: "That note was definitely flat. <guess> doesn't fit the harmony." },
  { headline: "FUMBLE!", location: "The 50-Yard Line", text: "The ball was dropped at <guess>. Turnover on downs." },
  { headline: "WRONG NUMBER", location: "Telephone Exchange", text: "\"I'm sorry, you have reached <guess>. Please check the number and dial again.\"" },
  { headline: "FLIGHT CANCELLED", location: "Heathrow", text: "The journey to <guess> has been grounded due to lack of evidence." },
  { headline: "SINKHOLE OPENS", location: "The Road", text: "The path to <guess> has collapsed. Proceed with caution." },
  { headline: "SERVER TIMEOUT", location: "The Data Center", text: "The connection to <guess> timed out. The host is unreachable." },
  { headline: "MISFIRE", location: "The Range", text: "The shot went wide. <guess> missed the target completely." },
  { headline: "FALSE POSITIVE", location: "The Lab", text: "Initial tests suggested <guess>, but the control sample proved otherwise." },
  { headline: "MISTRIAL DECLARED", location: "The Courtroom", text: "Evidence for <guess> was tampered with. We must start over." },
  { headline: "DIPLOMATIC INCIDENT", location: "The UN", text: "Calling it <guess> has offended the delegates. Apologies issued." },
  { headline: "TYPO DETECTED", location: "The Editor's Desk", text: "Did you mean something else? <guess> doesn't look right." },
  { headline: "WRONG TURN", location: "Albuquerque", text: "We should have taken a left at <guess>. We are now lost." },
  { headline: "THE DOG ATE IT", location: "The Classroom", text: "The homework saying <guess> is missing. A likely excuse." },
  { headline: "BLUE SCREEN OF DEATH", location: "Redmond", text: "A critical error occurred while processing <guess>." },
  { headline: "FAKE ID", location: "The Club", text: "The bouncer took one look at <guess> and shook his head. \"Not tonight.\"" },
]
